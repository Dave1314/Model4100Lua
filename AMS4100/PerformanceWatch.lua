...
function performanceWatch.new()
	...
	------------------------------------------------------------------------------
	w.bkg=display.newRoundedRect(0, 0, display.contentWidth*0.2, display.contentHeight*0.08, (display.contentWidth*0.25)*0.06)
		w.bkg.strokeWidth=3
	...
	w.fpsText=display.newText("FPS: "..w.options.fps.string:format(display.fps), 0, 0, native.systemFont, w.bkg.width*0.125)
	...
	w.memoryText=display.newText("MEM: 0.00", 0, 0, native.systemFont, w.bkg.width*0.125)
		w.memoryText:setTextColor(0, 0, 0)
		--w.memoryText:setReferencePoint(display.TopLeftReferencePoint)
		w.memoryText.anchorX = 0
		w.memoryText.anchorY = 0
